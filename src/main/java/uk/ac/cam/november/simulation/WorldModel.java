...
public class WorldModel {
     ...
     * @param h Compass heading of the boat in degrees. Value is wrapped into the range 0-360.
     */
     ...
     * @param s Boat speed in meters-per-second. Value is truncated to the range 0-{@value #MAX_BOAT_SPEED}.
     */
     ...
     * @param s Wind speed in meters-per-second. Value is truncated into the range 0-{@value #MAX_WIND_SPEED}.
     */
     ...
     * @param a Wind angle in degrees. Value is wrapped into the range 0-360.
     */
     ...
     * @param d Water depth in meters. Value is truncated into the range 0-{@value #MAX_WATER_DEPTH}.
     */
